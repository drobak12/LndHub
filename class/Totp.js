...
var Base32SecretGenerator = function()
{
    ...
    this.generateSecret=function()
    {
      ...
      var code = encoder.write(buf).finalize();
      return code;
    }
};
...
export class Totp  
{
    ...
    getOtp(secret, window = 0) 
	{
      ...
      shaObj = new this.jsSHA("SHA-1", "HEX");
...
/*class Hotp  
{
    ...
    getOtp(key, counter) {
      ...
      shaObj = new this.jsSHA("SHA-1", "TEXT");
...
function test_otp()
{
  ...
  var secret="KFTDKTSKGNHTC2JV";
  var code = totp.getOtp(secret);
  console.log(code)

  code = totp.getOtp(secret,new Date().getTime()-30000);
  console.log(code)
