...
export class MockMS extends IExchangeService {
  ...
  async loadStableCoin(userId, transactionId, amountBtc, currencyOrigin, currencyDestination) {
    ...
    return new TransactionExchange(uuidv4(), transactionId, amountBtc, currencyOrigin, currencyDestination, amountUSDC, 0, 0);
  }
  ...
  async unloadStableCoin(userId, transactionId, amountUSDC, currencyOrigin, currencyDestination) {
    ...
    return new TransactionExchange(uuidv4(), transactionId, amountUSDC, currencyOrigin, currencyDestination, amountBTC, 0, 0);
  }
